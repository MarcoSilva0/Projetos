...
<body>
    ...
    ?>
            <form action='update.php' method='post'>
                <div class='campos'>
                    <span>ID: </span>
                    <input type='text' name='pk_aluno' value='<?php echo $linha['pk_aluno'] ?>' disabled>
                    <!-- O input abaixo serve para pegar os dados e conseguir mandar para o banco no update
                    pq sem ele o usuario irá conseguir mudar o ID e não queremos mas se usar só o disable ele na da update-->
                ...
                <div class='campos'>
                    ...
                    <input type="date" name="datanascimento" value='<?php echo $linha['datanascimento'] ?>' required>
                </div>
                <div class="botoes">
